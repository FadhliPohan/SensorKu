            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tbl_staff.php">Laporan Masuk</a>
                        <a class="collapse-item" href="tbl_kepala.php">Laporan Selesai Tugas</a>

                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Laporan Lainnya:</h6>
                        <a class="collapse-item" href="tbl_user.php">Laporan Diterima</a>
                        <a class="collapse-item" href="tbl_su.php">Laporan Ditolak </a>
                        <a class="collapse-item" href="tbl_user.php">Laporan Diverifikasi</a>
                        <a class="collapse-item" href="tbl_su.php">Laporan Belum Diverifikasi </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tbl_user.php">Surat Penugasan</a>
                    </div>
                </div>
            </li>
